...
public class ClinicRankAdapter extends BaseAdapter {
    ...
    public ClinicRankAdapter(Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (itemView == null)
            itemView = LayoutInflater.from(context).inflate(R.layout.clinic_rank_item, viewGroup, false);
    ...
    private class ViewHolder {
        private TextView nama, alamat, jarak, skor;
        ...
        ViewHolder(View view) {
            ...
            skor = view.findViewById(R.id.skor);
        ...
        void bind(ClinicClass clinic) {
            ...
            skor.setText(String.format("%.5f", clinic.getScore()));
